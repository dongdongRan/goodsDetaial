...
//        self.defaultAnimationType = SVProgressHUDAnimationTypeNative;
...
- (SVIndefiniteAnimatedView *)createIndefiniteAnimatedView{
   ...
   // indefiniteAnimatedView.strokeColor = self.foregroundColorForStyle;
    ...
    gifImageView.frame = indefiniteAnimatedView.bounds;
    
    [indefiniteAnimatedView addSubview:gifImageView];
