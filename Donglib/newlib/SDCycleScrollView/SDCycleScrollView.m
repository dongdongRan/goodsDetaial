...
//    float offSet = scrollView.contentOffset.x/320 - (int)(scrollView.contentOffset.x/320);
    float offSet = scrollView.contentOffset.x;
    
//    NSLog(@"%f",offSet);
    
//    if ([self.delegate respondsToSelector:@selector(cycleScrollView:didScrollToIndex: offSet:)]) {
//        [self.delegate cycleScrollView:self didScrollToIndex:indexOnPageControl offSet:offSet];
